...
public class halaman_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("SMKN2 PEKALONGAN");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(31, 350, 200, -1));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, 140, 150));
    ...
    private void L_btn_loginActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_L_btn_loginActionPerformed
        ...
        try (Connection conn = Koneksi.getConnection()) {
            ...
            if (rs.next()) {
                String id = rs.getString("id"); // <-- TAMBAHKAN INI
                String jabatan = rs.getString("jabatan");
                String usernameDb = rs.getString("username");
                String telepon = rs.getString("telepon");
                String alamat = rs.getString("alamat");

                UserSession.createSession(id, usernameDb, jabatan, telepon, alamat);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(halaman_login.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
